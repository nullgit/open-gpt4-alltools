...
if __name__ == '__main__':
    url = path2url('/Users/fanque/workspace/project/ai/language-model/paper/识图/Qwen-VL- A Versatile Vision-Language Model for Understanding, Localization, Text Reading, and Beyond.pdf', 'tmp.pdf')
    print(url)
